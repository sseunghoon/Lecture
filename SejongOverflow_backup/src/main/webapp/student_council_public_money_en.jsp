...
<html lang="ko" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>College of Software Convergence :: Student Council :: Public Money</title>
  ...
  %>
    ...
    <section class="content">
      ...
      <hr>
      <a class= "btn btn-default pull-right" href="student_council_public_money_Write.jsp">Write</a>
